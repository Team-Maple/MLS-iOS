...
public final class DictionarySearchReactor: Reactor {
    ...
    public let recentSearchRepository: RecentSearchRepository
    ...
    public func mutate(action: Action) -> Observable<Mutation> {
        switch action {
        case .viewWillAppear:
            return recentSearchRepository.fetchRecentSearch().map { Mutation.setRecentList($0) }
        case .backButtonTapped:
