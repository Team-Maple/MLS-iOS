...
private extension DictionaryListReactor {
    func fetchList(sort: String?, startLevel: Int?, endLevel: Int?, updateBookmarkOnly: Bool = false) -> Observable<Mutation> {
        ...
        case .monster:
            response = dictionaryListAPIRepository.fetchMonsterList(
        ...
        case .item:
            response = dictionaryListAPIRepository.fetchItemList(
                keyword: currentState.keyword ?? "",
        ...
        case .map:
            response = dictionaryListAPIRepository.fetchMapList(
                keyword: currentState.keyword ?? "",
                page: currentState.currentPage,
                size: 20,
                sort: sort ?? "ASC"
        ...
        case .npc:
            response = dictionaryListAPIRepository.fetchNpcList(
                keyword: currentState.keyword ?? "",
                page: currentState.currentPage,
                size: 20,
                sort: sort ?? "ASC"
        ...
        case .quest:
            response = dictionaryListAPIRepository.fetchQuestList(
                keyword: currentState.keyword ?? "",
                page: currentState.currentPage,
                size: 20,
                sort: sort ?? "ASC"
        ...
        case .total:
            response = dictionaryListAPIRepository.fetchAllList(
                keyword: currentState.keyword ?? "",
                page: currentState.currentPage
            )
        default:
