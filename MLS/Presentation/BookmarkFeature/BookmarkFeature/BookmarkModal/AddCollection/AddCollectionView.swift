...
private extension AddCollectionView {
    ...
    func setupConstraints() {
        ...
        nameLabel.snp.makeConstraints { make in
            make.top.equalTo(titleLabel.snp.bottom).offset(Constant.nameLabelTopMargin)
            make.horizontalEdges.equalToSuperview().inset(Constant.horizontalMargin)
        }
        
        inputTextView.snp.makeConstraints { make in
            make.top.equalTo(nameLabel.snp.bottom).offset(Constant.nameLabelBottomMargin)
            make.horizontalEdges.equalToSuperview().inset(Constant.horizontalMargin)
            make.height.equalTo(Constant.inputHeight)
        }
        
        errorMessage.snp.makeConstraints { make in
            make.bottom.equalTo(completeButton.snp.top).offset(-Constant.buttonBottomMargin)
            make.centerX.equalToSuperview()
        }
        
        completeButton.snp.makeConstraints { make in
            make.top.equalTo(inputTextView.snp.bottom).offset(Constant.buttonTopMargin)
            make.horizontalEdges.equalToSuperview().inset(Constant.horizontalMargin)
            addButtonBottomConstraint = make.bottom.equalToSuperview().inset(Constant.buttonBottomMargin).constraint
        }
    }
}
