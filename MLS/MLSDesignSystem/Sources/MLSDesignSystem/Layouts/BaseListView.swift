...
public extension BaseListView {
    func updateFilter(sortType: String?) {
        ...
        if let sortType = sortType {
            sortButton.setAttributedTitle(.makeStyledString(font: .b_s_r, text: sortType, color: sortButton.tintColor), for: .normal)
        }
    }
    ...
    func selectSort(selectedType: String) {
        sortButton.setAttributedTitle(.makeStyledString(font: .b_s_r, text: selectedType, color: .primary700), for: .normal)
