...
public final class NavigationBar: UIView {
    ...
    public let leftButton: UIButton = {
        ...
        button.setImage(DesignSystemAsset.image(named: "arrowBack").withRenderingMode(.alwaysTemplate), for: .normal)
    ...
    public let rightButton: UIButton = {
        let button = UIButton(type: .system)
        button.setImage(DesignSystemAsset.image(named: "arrowForward").withRenderingMode(.alwaysTemplate), for: .normal)
        button.tintColor = .textColor
        return button
    }()
    ...
    public let editButton: UIButton = {
        let button = UIButton()
        button.setImage(DesignSystemAsset.image(named: "edit"), for: .normal)
        return button
    }()

    public let addButton: UIButton = {
        let button = UIButton()
        button.setImage(DesignSystemAsset.image(named: "addIcon"), for: .normal)
        return button
    }()
