...
final class BookmarkOnBoardingView: UIView {
    enum OnBoardingIndexType: Int {
        case first = 0
        case second
        case end
    ...
    let nextButton = CommonButton(style: .normal, title: "다음", disabledTitle: nil)
...
extension BookmarkOnBoardingView {
