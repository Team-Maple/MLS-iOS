...
public struct DictionaryNPCListResponseDTO: Codable {
    ...
    public struct DictionaryItemDTO: Codable {
        ...
        public func toDomain() -> DictionaryMainItemResponse {
            return DictionaryMainItemResponse(id: npcId, name: name, imageUrl: imageUrl, type: type, isBookmarked: isBookmarked)
        }
    }
