...
extension AppDelegate: UNUserNotificationCenterDelegate, MessagingDelegate {
    ...
    func messaging(
        ...
        let tokenRepo = DIContainer.resolve(type: TokenRepository.self)
        let saveResult = tokenRepo.saveToken(type: .fcmToken, value: fcmToken)
        ...
        if case .success(let accessToken) = tokenRepo.fetchToken(type: .accessToken),
           !accessToken.isEmpty {
            _ = tokenRepo.saveToken(type: .fcmToken, value: fcmToken)
